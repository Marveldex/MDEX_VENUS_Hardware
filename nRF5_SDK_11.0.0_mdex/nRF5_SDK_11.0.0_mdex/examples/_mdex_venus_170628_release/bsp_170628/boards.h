...
#include "nrf_gpio.h"
  ...
  #include "custom_board_venus_1_1.h"
  //#include "custom_board_mercury.h"
  //#include "custom_board.h"
#elif defined(BOARD_VENUS_MINI)
  #include "custom_board_venus_mini.h"
#else
#error "Board is not defined"

#endif

//	sehjin12 - changed name : LEDS_OFF <--> LEDS_ON
