...
void nrf_drv_gpiote_out_high(nrf_drv_gpiote_pin_t pin);
void nrf_drv_gpiote_out_high_to_led_off(nrf_drv_gpiote_pin_t pin);
...
void nrf_drv_gpiote_out_low(nrf_drv_gpiote_pin_t pin);
void nrf_drv_gpiote_out_low_to_led_on(nrf_drv_gpiote_pin_t pin);
