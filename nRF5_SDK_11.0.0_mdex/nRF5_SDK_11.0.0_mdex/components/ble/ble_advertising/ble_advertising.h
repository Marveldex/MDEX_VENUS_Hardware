...
typedef enum
{
    BLE_ADV_EVT_IDLE,                /**< 0 Idle; no connectable advertising is ongoing.*/
    BLE_ADV_EVT_DIRECTED,            /**< 1 Direct advertising mode has started. */
    BLE_ADV_EVT_DIRECTED_SLOW,       /**< 2 Directed advertising (low duty cycle) has started. */
    BLE_ADV_EVT_FAST,                /**< 3 Fast advertising mode has started. */
    BLE_ADV_EVT_SLOW,                /**< 4 Slow advertising mode has started.*/
    BLE_ADV_EVT_FAST_WHITELIST,      /**< 5 Fast advertising mode using the whitelist has started. */
    BLE_ADV_EVT_SLOW_WHITELIST,      /**< 6 Slow advertising mode using the whitelist has started.*/
    BLE_ADV_EVT_WHITELIST_REQUEST,   /**< 7 Request a whitelist from the main application. For whitelist advertising to work, the whitelist must be set when this event occurs. */
    BLE_ADV_EVT_PEER_ADDR_REQUEST    /**< 8 Request a peer address from the main application. For directed advertising to work, the peer address must be set when this event occurs. */
} ble_adv_evt_t;
